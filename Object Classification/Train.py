#
# train an SSD model on Open Images datasets
#
import os
import sys
import logging
...
parser.add_argument('--net', default="mb1-ssd",
                    help="The network architecture, it can be mb1-ssd, mb1-lite-ssd")
...
if __name__ == '__main__':
    ...
    optimizer = torch.optim.SGD(params, lr=.0001, momentum=args.momentum,
